...
<div class="bodywrapper">
    ...
    <?php if($level=="1"){ ?><!--Administrator-->
            <li><a href="<?php echo base_url();?>admin/laporan" class="editor">Manajemen User</a></li>            
            <li><a href="<?php echo base_url();?>admin/laporan" class="editor">Manajemen Lembaga</a></li>
            <li><a href="<?php echo base_url();?>admin/laporan" class="editor">Konfirmasi PSB</a></li>
            <li><a href="<?php echo base_url();?>admin/laporan" class="editor">Pesan</a></li>            

    <?php } elseif($level=="2"){ ?><!--Staff PIP-->

    <?php } elseif($level=="3"){ ?><!--Keamanan-->

    <?php } elseif($level=="4"){ ?><!--Sekolah-->
