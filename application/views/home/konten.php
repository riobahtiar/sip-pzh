...
<div class="panel-heading" id="border-orange-bawah"><i class="fa fa-star fa-spin" ><a href="/localhost"></a> </i> &nbsp;&nbsp;<b>Pengumuman Terbaru </b><span class="pull-right"><b><i class="fa fa-folder"></i> Arsip</b></span></div>
  <div class="panel-body">
    <?php foreach ($query as $hm): ?>
    <div class="bs-callout bs-callout-info">
      <h4><?php echo $hm->judul_pengumuman ?></h4>
            <h5><span class="label label-pengumuman"><span class="fa fa-bookmark-o"></span>  Pengumuman Dari :</span><span class="label label-pengumuman-samping"><?php echo $hm->kategori ?></span></h5>
    </div>
    <?php endforeach; ?>  
...
<div class="panel panel-primary">
  <div class="panel-heading" id="border-orange-bawah"><i class="fa fa-bar-chart-o"> </i> &nbsp;&nbsp;<b>Statistik Santri</b></div>

  <div class="panel-body">
    <img src="<?php echo base_url() ?>assetx/img/sample.png" width="835" height="282" alt="ChartSantri"> </div>
</div>

<div class="panel panel-primary">
  <div class="panel-heading" id="border-orange-bawah"><i class="fa fa-bar-chart-o"> </i> &nbsp;&nbsp;<b>Statistik Santri</b></div>

  <div class="panel-body col-1">
...
<div class="list-group ">
  ...
  <a href="#" class="list-group-item">
    <h4 class="list-group-item-heading"><span class="fa fa-sitemap"></span>&nbsp;&nbsp;<b>STAFF & GURU</b></h4>
    <p class="list-group-item-text">Informasi dan Pengumuman Terbaru untuk Pengurus dan Guru</p>
  </a>
  <a href="#" class="list-group-item">
    <h4 class="list-group-item-heading"><span class="fa fa-smile-o"></span>&nbsp;&nbsp;<b>ALUMNI & UMUM</b></h4>
...
<!--Widget 3 -->
<div class="panel panel-primary">
  <div class="panel-heading" id="border-orange-bawah"><span class="fa fa-external-link-square"></span>&nbsp;&nbsp;<b>Sponsor</b></div>
<img src="<?php echo base_url() ?>assetx/img/ban.png">
</div>
<!--Widget 4 -->
<div class="panel panel-primary">
  <div class="panel-heading" id="border-orange-bawah">Berita Terbaru w3</div>
...
<!--Widget 5 -->
<div class="panel panel-primary">
  <div class="panel-heading" id="border-orange-bawah"> Berita Terbaru</div>
  <div class="panel-body col-1">
    Panel content
  </div>
</div>
